...
export default async function () {
  ...
  try {
    ...
    page.$('table[name="menu_table"] tbody tr[name="menu'+(expectedLenght+1)+'"]').scrollIntoViewIfNeeded();

    const menu = page.$('table[name="menu_table"] tbody tr[name="menu'+(expectedLenght+1)+'"]')
