...
<form:form method="POST" action="guardar_des_comida" modelAttribute="des_comida" cssClass="text-light p-3 fs-4">
    <form:hidden path="id"/>
    <form:hidden path="desempenyoMenu"/>

    <form:label path="comido">¿Te has comido el plato?</form:label><br>
    <form:radiobutton path="comido" value="true" label=" Sí  "/>
    <form:radiobutton path="comido" value="false" label=" No"/><br>

    <form:label path="gustado">¿Te ha gustado el plato?</form:label><br>
